...
import com.ssm.tpssystem.service.ClientService;
...
//        trade.setCreator_id(creator_id);
    ...
    @RequestMapping(value = "/displayClient", method = RequestMethod.POST, produces = "application/json; charset=UTF-8")
    @ResponseBody
    public RestResult DisplayClient(HttpServletResponse httpServletResponse){
        return resultGenerator.getSuccessResult(clientService.findAllClient());
